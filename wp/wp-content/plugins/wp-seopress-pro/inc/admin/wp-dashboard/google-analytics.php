...
/**
 * @deprecated 5.9.0
 * @uses seopress_get_service('AdvancedOption')
 */
...
<div id="seopress-tabs2">
    <div id="sp-tabs-1" class="seopress-tab ui-widget-content">
        <!-- //Sessions -->
        <div class="wrap-single-stat-ga4 wrap-single-stat">
            <span class="label-stat">
                <span class="dashicons dashicons-visibility"></span>
                <?php _e('Sessions', 'wp-seopress-pro'); ?>
            </span>
            <span id="seopress-ga-sessions" class="value-stat"></span>
        </div>
        ...
        <div class="wrap-single-stat-ga4 wrap-single-stat">
            ...
            <span id="seopress-ga-users" class="value-stat"></span>
        </div>
        ...
        <div class="wrap-single-stat-ga4 wrap-single-stat">
            ...
            <span id="seopress-ga-pageviews" class="value-stat"></span>
        </div>
        ...
        <div class="wrap-single-stat-ga4 wrap-single-stat">
            ...
            <span id="seopress-ga-avgSessionDuration" class="value-stat"></span>
        </div>
    </div>
</div>
<?php }
...
<p><?php _e('Make sure you have enabled these 3 APIs from <strong>Google Cloud Console</strong>:', 'wp-seopress-pro'); ?>
</p>
<ul>
