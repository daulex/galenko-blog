...
<p>
    <a class="logout btn btnSecondary"
...
<div class="seopress-notice is-warning">
    <p>
        <strong><?php _e('Empty list?','wp-seopress-pro'); ?></strong> <?php _e('You are probably using GA4. To get your stats in WP dashboard for GA4 properties, enter the property ID to the field below and save changes.','wp-seopress-pro'); ?>
    </p>
</div>
